...
<qgis version="3.40.15-Bratislava">
  <identifier>mfebelvis</identifier>
  <parentidentifier></parentidentifier>
  <language>ES</language>
  <type>dataset</type>
  <title>mfebelvis</title>
...
REQUIRED: A summary of the intentions with which the data set was developed.</abstract>
  ...
  <links>
    <link size="" mimeType="" type="Local Area Network" url="file://\\PC\C$\TEXTOS\proyectos\pinnova2002.uam\Libro_ArcGIS_Ver_0.3\CD_DATOS\Parte8\mfebelvis" description="" name="Shapefile" format=""/>
  </links>
  <dates/>
  <fees></fees>
